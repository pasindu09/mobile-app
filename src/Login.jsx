  ...
  return(
    ...
    <div class="bg-gray-100 p-5 flex rounded-2xl shadow-lg max-w-3xl">
      <div class="md:w-1/2 px-5">
        ...
        <p class="text-sm mt-4">If you have an account, please login</p>
      ...
      <div className="w-1/2 md:block hidden border">
  <img src={img1} className="rounded-2xl object-cover w-full h-full" alt="page img"/>
</div>
